...
export const renderDashboard = (appContainer: HTMLElement) => {
    ...
    appContainer.innerHTML = `
        <div class="w-full h-full flex flex-col bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-200">
            <header class="flex justify-between items-center p-5 md:p-8 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 shrink-0">
                <h2 class="text-3xl font-bold">功能选区</h2>
